...
<head>
    ...
    <title>Workers </title>
    <link href="{{asset('workers_dashboard/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                <div class="sidebar-brand-text mx-3"><img src="{{asset('logo/Logo-white.png')}}" class="img img-responsive img-logo d-xs-none" alt=""></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/account/company/profile">
            ...
            <li class="nav-item">
                ...
                <div id="collapseJob" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/company/post/createfree">Post a New Job</a>
                        <a class="collapse-item" href="/company/post/manage">Manage Jobs</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('message-chat') }}">
                    <i class="fas fa-fw">
                        <img src="{{asset('icons/message-2.png')}}" style="margin-bottom: -15px;margin-left: 6px;" alt="">

<div class="modal fade" id="quickSignupAll" tabindex="-1" role="dialog">
			...
			<div class="signup-wrap">
				...
				<div class="modal-body">
					...
					<div class="signup-one">
						<div class="signup-heading mb-2">{{ t('sign_up') }}</div>
						<form role="form" method="POST">
							<div class="form-group row mb-4">
								<input type="hidden" name="user_type" id="userType"/>
								<div class="col-md-6">
									<button type="button" class="btn btn-lg btn-user-type userTypeBtn" rel="2">{{ t('worker') }}</button>
								</div>
								<div class="col-md-6">
									<button type="button" class="btn btn-lg btn-user-type userTypeBtn" rel="1">{{t('employer')}}</button>
								</div>
							</div>
							<div class="form-group row mb-4 help-user-error" style="display: none;">
								<div class="col-md-12 help-user-type-error text-danger">
							...
							<div class="form-group row required">
								<div class="col-md-12">
									<div class="input-group show-pwd-group">
										<input id="emailAll" name="email" type="email" class="form-control" placeholder="{{ t('email') }}" autocomplete="off">
							...
							<div class="form-group row required">
								<div class="col-md-12">
									<div class="input-group show-pwd-group">
										<input id="passwordAll" name="password" type="password" class="form-control" placeholder="{{ t('password') }}" autocomplete="off">
										<span class="icon-append show-pwd">
							 ...
							 <div class="alert alert-danger print-error-msg-all" style="display:none">
						        <ul></ul>
						    </div>
							...
							<div class="form-group row mt-5">
								<div class="col-md-12">
									<button id="signupBtnAllFirst" class="btn btn-custom btn-lg "> {{ t('Next') }} </button>
								</div>
							</div>
							...
							<div class="social-icon-main">
								<ul>
									<li class="btn-lkin"><a href="{{ url('auth/linkedin') }}?type=signup" class="btn-lkin userCheckType" onclick="return  checkUserSelectedOnSignup(this)"><svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<li class="btn-tw">
										<a href="{{ url('auth/twitter') }}?type=signup" class="btn-tw userCheckType" onclick="return checkUserSelectedOnSignup(this)">
									...
									<li class="btn-fb">
										<a href="{{ url('auth/facebook') }}?type=signup" class="btn-fb userCheckType" onclick="return checkUserSelectedOnSignup(this)"><svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<li ><a href="{{ url('auth/google') }}?type=signup"  class="userCheckType" onclick="return checkUserSelectedOnSignup(this)">
										<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<defs>
											<linearGradient id="paint0_linear1" x1="24.9166" y1="14.0802" x2="24.9166" y2="35.6807" gradientUnits="userSpaceOnUse">
									...
									<li class="btn-yw"><a href="{{ url('auth/yahoo') }}?type=signup" onclick="return checkUserSelectedOnSignup(this)" class="btn-yw userCheckType">
					...
					<div class="signup-two" style="display:none">
						...
						<form role="form" method="POST">
							...
							<div class="form-group row required">
								<div class="col-md-12">
									<div class="input-group show-pwd-group">
										<input id="first_name_a" name="first_name" type="text" class="form-control" placeholder="{{ t('first_name') }}" autocomplete="off" >
										<span class="icon-append show-pwd">
											<button type="button" class="first_name_a">
							...
							<div class="form-group row required">
								<div class="col-md-12">
									<div class="input-group show-pwd-group">
										<input id="last_name_a" name="last_name" type="text" class="form-control" placeholder="{{ t('last_name') }}" autocomplete="off" >
										<span class="icon-append show-pwd">
											<button type="button" class="last_name_a">
												<img src="{{ asset('/images/name_icon.png') }}" class="input-img" />
											</button>
										</span>
									</div>
							...
							<div class="form-group row required">
								<div class="col-md-12">
									<div class="input-group show-pwd-group">
										<input id="country_a" name="country" type="text" class="form-control" placeholder="Philippines" autocomplete="off" value="Philippines" disabled="disabled">
										<span class="icon-append show-pwd">
											<button type="button" class="country_a">
								...
								<div class="col-md-12">
									<div class="input-group show-pwd-group">
										<div class="input-group">
											<select id="city_a" name="city" class="form-control">
											...
											<span class="icon-append show-pwd">
												<button type="button" class="city_a">
							...
							<div class="alert alert-danger print-error-msg-all-two" style="display:none">
						        <ul></ul>
						    </div>
							...
							<div class="form-group row mt-5 mb-5">
								<div class="col-md-12">
									<button id="signupBtnAllSecond" class="btn btn-custom btn-lg "> {{ t('submit') }} </button>
								</div>
							</div>
						</form>
					</div>
			...
			<div class="signup-three" style="display:none">
				...
				<div class="signup-code-wrap">
				    ...
				    <div class="alert-remail" >
						...
						<span class="resend-mail sendMailAll">{{t('resend_verification_code')}}</span>
				    </div>
				</div>
				<div class="ver-code-wrap">
					<form role="form" method="POST">
						<div class="form-group row required">
							<div class="col-md-12">
								<div class="input-group show-pwd-group">
									<input id="code_a" name="code" type="text" class="form-control" placeholder="{{t('enter_verification_code')}}" autocomplete="off" >
									<span class="icon-append show-pwd">
										<button type="button" class="code_a">
						...
						<div class="alert alert-danger print-error-msg-all-three" style="display:none">
					        <ul></ul>
					    </div>
					    <div class="alert alert-success print-success-msg-all-three" style="display:none">
					        <ul></ul>
					    </div>
						...
						<div class="form-group row mt-5 mb-5">
							<div class="col-md-12">
								<button id="signupBtnAllThird" class="btn btn-custom btn-lg "> {{ t('submit') }} </button>
							</div>
						</div>
					</form>
				</div>

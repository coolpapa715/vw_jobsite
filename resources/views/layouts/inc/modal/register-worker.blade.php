<div class="modal fade" id="quickSignup" tabindex="-1" role="dialog">
					...
					<div class="signup-one">
						...
						<form role="form" method="POST" >
							...
							<div class="form-group row required">
								<div class="col-md-12">
									<div class="input-group show-pwd-group">
										<input id="email" name="email" type="email" class="form-control" placeholder="{{ t('email') }}" autocomplete="off" >
							...
							<div class="form-group row mt-5">
								<div class="col-md-12">
									<button id="signupBtnFirst" class="btn btn-custom btn-lg "> {{ t('Next') }} </button>
								</div>
							</div>
					...
					<div class="signup-two" style="display:none">
						...
						<form role="form" method="POST">
							...
							<div class="form-group row required">
								<div class="col-md-12">
									<div class="input-group show-pwd-group">
										<input id="first_name_w" name="first_name" type="text" class="form-control" placeholder="{{ t('first_name') }}" autocomplete="off" >
										<span class="icon-append show-pwd">
							...
							<div class="form-group row required">
								<div class="col-md-12">
									<div class="input-group show-pwd-group">
										<input id="last_name_w" name="last_name" type="text" class="form-control" placeholder="{{ t('last_name') }}" autocomplete="off" >
										<span class="icon-append show-pwd">
							...
							<div class="form-group row required">
								<div class="col-md-12">
									<div class="input-group show-pwd-group">
										<input id="country_w" name="country" type="text" class="form-control" placeholder="Philippines" autocomplete="off" value="Philippines" disabled="disabled">
										<span class="icon-append show-pwd">
							...
							<div class="form-group row mt-5 mb-5">
								<div class="col-md-12">
									<button id="signupBtnWSecond" class="btn btn-custom btn-lg "> {{ t('submit') }} </button>
								</div>
							</div>
						</form>
					</div>
				...
				<div class="ver-code-wrap">
					<form role="form" method="POST">
						<div class="form-group row required">
							<div class="col-md-12">
								<div class="input-group show-pwd-group">
									<input id="code_w" name="code" type="text" class="form-control" placeholder="{{t('enter_verification_code')}}" autocomplete="off" >
									<span class="icon-append show-pwd">
						...
						<div class="form-group row mt-5 mb-5">
							<div class="col-md-12">
								<button id="signupBtnWThird" class="btn btn-custom btn-lg "> {{ t('submit') }} </button>
							</div>
						</div>
					</form>
				</div>

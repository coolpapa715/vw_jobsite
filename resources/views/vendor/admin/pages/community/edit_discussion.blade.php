        ...
        <form method="POST" action="{{ request()->fullUrl() }}">
            <div class="card border-top border-primary">
                ...
                <div class="card-header">
                    <h3 class="mb-0">Update chatter category type</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="card mb-0">
                        <div class="row">
                            <div class="form-group col-md-2">
                                <label>Order</label>
                                <input type="number" name="order" placeholder="Category order" value="{{$category->order}}" class="form-control" min='1'>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                <label>Slug</label>
                                <input type="text" name="slug" placeholder="Category slug" value="{{$category->slug}}" class="form-control">
                            </div>
                            
                            <div class="form-group col-md-2">
                                <label>Color</label>
                                <input type="color" name="color" placeholder="Category color" value="{{$category->color}}" class="form-control">
                            </div>

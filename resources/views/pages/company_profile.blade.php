...
<div class="job-details">
    <div class="job-banner">
        <div class="media">
            <img src="{{ url()->asset('public/images/newdesign/img.png') . getPictureVersion() }}" class="bg-danger" alt="Avatar">
    ...
    <div class="resumes container container-max container-fluid">
        <h3 class="breadcrumb">Home / Resumes</h3>
        <div class="d-flex flex-row">
            <div class="content about_company">
                <h2>About Company</h2>
                <p>Moody’s Corporation, often referred to as Moody’s, is an American business and financial services company. It is the holding company for Moody’s Investors Service (MIS), an American credit rating agency, and Moody’s Analytics (MA), an American provider of financial analysis software and services.</p><p> Moody’s was founded by John Moody in 1909 to produce manuals of statistics related to stocks and bonds and bond ratings. Moody’s was acquired by Dun & Bradstreet in 1962. In 2000, Dun & Bradstreet spun off Moody’s Corporation as a separate company that was listed on the NYSE under MCO. In 2007, Moody’s Corporation was split into two operating divisions, Moody’s Investors Service, the rating agency, and Moody’s Analytics, with all of its other products.</p>
                <!-- <div class="row">
                    <div class="col-md-3">
                ...
                <div class="share-job">
                    <div class="share-text"><span>Share this job</span></div>
                    <ul>
                        <li class="facebook">
                            <a href="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-facebook"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg> <span>Facebook</span>
                            </a>
                        </li>
                        <li class="twitter">
                            <a href="">
            ...
            <div>
                <div class="lightbox">
                    <div class="job-overview">
                        <h2 class="job-overview-title">Job Over View</h2>
                ...
                <div class="location">
                   <h2>Job Location</h2>
                   <img src="{{ url()->asset('public/images/newdesign/maps.png') . getPictureVersion() }}" alt="Map Image">
        ...
        <div class="overview">
            <div class="invisionview-profile">
                <div class="invisiion-block">
                    <span></span>
                </div>
                <div class="invision-text">
                    <h2>InVision</h2>

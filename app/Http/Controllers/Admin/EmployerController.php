...
class EmployerController extends FrontController
{
	public function index()
	{
		...
		$Educationlist = DB::table('education_levels')->get();
		$skilllist = DB::table('job_skills')->get();
		$Experiencelist =  DB::table('experience')->get();
		$Specilitieslist =  DB::table('specialities')->get();
